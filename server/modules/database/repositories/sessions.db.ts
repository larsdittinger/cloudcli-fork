...
const SESSION_ROW_COLUMNS =
  'session_id, provider, provider_session_id, project_path, jsonl_path, custom_name, model, effort, owner_user_id, forked_from_session_id, isArchived, created_at, updated_at';
